...
parameters = p1.pegasos(train_bow_features, train_labels, 25, 0.0100)
predictions = p1.classify(test_bow_features, parameters[0], parameters[1])
accuracy = p1.accuracy(predictions, test_labels)
